...
(function($) {
  ...
  $.fn.lightBox = function(settings) {
    ...
    function _resize_container_image_box(intImageWidth,intImageHeight) {
      ...
      $('#lightbox-container-image-box').animate({ width: intWidth + 50, height: intHeight + 100},settings.containerResizeSpeed,function() { _show_image(); });
      ...
      if ( settings.activeImage != 0 ) {
        if ( settings.fixedNavigation ) {
          ...
          $('#lightbox-nav-btnPrev').unbind().hover(function() {
            $(this).css({ 'background' : 'url(' + settings.imageBtnPrev + ') left cennter no-repeat' });
          },function() {
