    ...
    if @type == "embed"
      ...
      if @embed_type == "photo"
        ...
        respond_to do |format|
          format.js { render :json => {:type => "photo", :html => '<div class="block-edit-image nobg"><div class="bl-img"><img src="'+ @url +'" alt="" embed="img" style="width:55px;height:55px;margin:0pt;" original="' + file_gripe.id.to_s + '"></div><div class="bl-content"><span class="span_val">Add are description.</span><textarea default="Add are description." class="tips ed-text"></textarea><div class="progresscontainer"><div class="progress ui-progressbar ui-widget ui-widget-content ui-corner-all hide-me" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="100"><div class="ui-progressbar-value ui-widget-header ui-corner-left ui-corner-right" style="width: 100%;"></div></div></div><div class="bl-delete">x delete</div><div class="clear"></div></div><div class="clear"></div></div>', :src => @url, :id => file_gripe.id  }}
        end      
      else
      	@src = @embed_url
      	@thumbnail_url = ''
        ...
        respond_to do |format|
          format.js { render :json => {:type => "video" , :thumbnail_url => @thumbnail_url.to_s, :src => @src, :id => file_gripe.id, :html => '<div class="block-edit-image nobg"><div class="bl-img"><img src="' + @thumbnail_url.to_s + '" alt="" embed="video" style="width:55px;height:55px;margin:0pt;" original="' + file_gripe.id.to_s + '"></div><div class="bl-content"><span class="span_val">Add are description.</span><textarea default="Add are description." class="tips ed-text"></textarea><div class="progresscontainer"><div class="progress ui-progressbar ui-widget ui-widget-content ui-corner-all hide-me" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="100"><div class="ui-progressbar-value ui-widget-header ui-corner-left ui-corner-right" style="width: 100%;"></div></div></div><div class="bl-delete">x delete</div><div class="clear"></div></div><div class="clear"></div></div>' }}
        end
      end
    else
      ...
      if resource == "photo"
        ...
        respond_to do |format|
          format.js { render :json => {:type => resource.type, :html => '<div class="block-edit-image nobg"><div class="bl-img"><img src="'+ @src +'" alt="" embed="img" style="width:55px;height:55px;margin:0pt;" original="' + file_gripe.id.to_s + '"></div><div class="bl-content"><span class="span_val">Add are description.</span><textarea default="Add are description." class="tips ed-text"></textarea><div class="progresscontainer"><div class="progress ui-progressbar ui-widget ui-widget-content ui-corner-all hide-me" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="100"><div class="ui-progressbar-value ui-widget-header ui-corner-left ui-corner-right" style="width: 100%;"></div></div></div><div class="bl-delete">x delete</div><div class="clear"></div></div><div class="clear"></div></div>', :src => @src, :id => file_gripe.id  }}
        end
      end
    end
  end
